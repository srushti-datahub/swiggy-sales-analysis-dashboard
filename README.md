...
Shows month-by-month revenue performance to identify seasonality and growth patterns.

2️⃣ Daily Sales Trend

Highlights revenue and order fluctuations across days of the week to detect peak ordering days.

3️⃣ Sales by Food Type (Veg vs Non-Veg)

Compares revenue contribution between vegetarian and non-vegetarian categories.

4️⃣ Sales by State (Map Visualization)

Displays geographic revenue distribution to identify high-performing regions.
...
Identifies leading cities contributing maximum revenue.

7️⃣ Weekly Trend Analysis

Tracks weekly fluctuations to detect business consistency or spikes.
